...
__all__ = [
    ...
    'DISPID_SPEDisplayText', 'SPEI_UNDEFINED', 'DISPID_SLPsCount',
    'SpPhoneConverter', 'SpeechRegistryUserRoot',
    ...
    'DISPID_SPAsCount', 'SDA_Consume_Leading_Spaces', 'SPSNoun',
    'DISPID_SVSkip', 'SVSFNLPSpeakPunc', 'DISPID_SRGRules',
    'eLEXTYPE_PRIVATE15', 'SPAUDIOSTATUS',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SOTDataKey',
    'DISPID_SpeechRecoContextEvents', 'SVP_21', 'DISPID_SLWType',
    'DISPID_SRCEBookmark', 'SVSFUnusedFlags', 'SPPS_LMA',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SpeechRecoResult2',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SRGetPropertyNumber',
    'SRATopLevel', 'SVSFVoiceMask', 'SGRSTTWildcard',
    'SPGRAMMARSTATE', 'DISPID_SBSSeek', 'DISPID_SVSLastResult',
    'SPSMF_UPS', 'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRSAudioStatus',
    'DISPIDSPRG', 'SAFTCCITT_ALaw_8kHzMono',
    'SpeechRegistryLocalMachineRoot', 'SpeechCategoryRecognizers',
    'eLEXTYPE_RESERVED9', 'SpeechPropertyLowConfidenceThreshold',
    'SGRSTTRule', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRCEPropertyNumberChange', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFTADPCM_44kHzStereo', 'DISPID_SPRsCount', 'SP_VISEME_1',
    'SPSHORTCUTTYPE', 'Speech_StreamPos_Asap',
    'DISPID_SPRDisplayAttributes', 'SpCustomStream', 'DISPID_SGRName',
    'SRSInactive', 'SpPhoneticAlphabetConverter',
    'DISPID_SpeechVoiceEvent', 'SP_VISEME_3', 'SVP_16',
    'DISPID_SPRuleId', 'eLEXTYPE_PRIVATE14',
    'DISPID_SpeechWaveFormatEx', 'SP_VISEME_11', 'SPBO_AHEAD',
    ...
    'SPPS_Function', 'eLEXTYPE_PRIVATE1', 'DISPID_SRGCmdLoadFromFile',
    'SPSHT_OTHER', 'SPEI_SENTENCE_BOUNDARY', 'ISpMMSysAudio',
    'SPEI_MIN_TTS', 'SDTLexicalForm', 'SGLexicalNoSpecialChars',
    'SpeechLoadOption', 'SPEI_END_SR_STREAM',
    'DISPID_SOTCEnumerateTokens', 'SDTReplacement', 'LONG_PTR',
    'DISPID_SpeechVoice', 'DISPID_SVSpeakStream', 'SP_VISEME_19',
    'SPXMLRESULTOPTIONS', 'SREStreamEnd', 'DISPID_SDKSetLongValue',
    'SpeechAudioState', 'eLEXTYPE_LETTERTOSOUND', 'ISpPhoneConverter',
    'SINoise', 'SAFT32kHz8BitMono', 'SAFTGSM610_8kHzMono', 'SVP_12',
    'SpeechDictationTopicSpelling', 'DISPID_SFSClose',
    'DISPID_SPPNumberOfElements', 'DISPID_SRGSetTextSelection',
    ...
    'SAFTADPCM_11kHzStereo', 'SLTApp', 'DISPID_SDKGetlongValue',
    'SPVPRI_ALERT', 'DISPID_SPEAudioStreamOffset', 'eWORDTYPE_ADDED',
    'STCInprocServer', 'eLEXTYPE_PRIVATE6', 'SLODynamic',
    'SRTAutopause', 'DISPID_SRCEEnginePrivate', 'DISPID_SPPs_NewEnum',
    'ISpGrammarBuilder', 'SPWORDTYPE', 'SpeechCategoryAudioOut',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRGRecoContext',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechCategoryRecoProfiles',
    'SPEI_SOUND_END', 'DISPID_SDKEnumKeys', 'SPEI_START_SR_STREAM',
    'SECHighConfidence', 'IInternetSecurityManager',
    'DISPID_SPRs_NewEnum', 'DISPID_SPERetainedStreamOffset',
    'SPRST_INACTIVE', 'SPPHRASE', 'DISPID_SpeechGrammarRule',
    'ISpAudio', 'DISPID_SRDisplayUI',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpObjectWithToken',
    'SPFM_CREATE_ALWAYS', 'SRTExtendableParse', 'DISPID_SLPs_NewEnum',
    'SPAS_PAUSE', 'SpCompressedLexicon', 'ISpeechRecoResultTimes',
    'SpeechInterference', 'SVEEndInputStream', 'DISPID_SPIGrammarId',
    'SPFM_CREATE', 'ISpeechLexiconPronunciations',
    'DISPID_SLGetWords', 'DISPID_SRGetRecognizers', 'SPVPRIORITY',
    'SP_VISEME_4', 'SSFMOpenReadWrite', 'ISpStreamFormatConverter',
    'DISPID_SLGetPronunciations', 'SPVOICESTATUS', 'SPSHT_Unknown',
    'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SPAStartElementInResult', 'DISPID_SLGetGenerationChange',
    ...
    'SECFDefault', 'SAFTGSM610_22kHzMono', 'DISPID_SVWaitUntilDone',
    'SVP_2', 'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SVSVisemeId',
    'SVP_4', 'DISPID_SOTCategory', 'SPEI_RESERVED6',
    ...
    'DISPID_SPIStartTime', 'SpUnCompressedLexicon', 'SPEVENT',
    'SPEI_SR_PRIVATE', 'DISPID_SVIsUISupported', 'eLEXTYPE_APP',
    'SpeechCategoryAudioIn', 'SPRECOGNIZERSTATUS', 'DISPID_SLPType',
    'SpeechPropertyResourceUsage', 'SPINTERFERENCE_NONE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPGRAMMARWORDTYPE',
    'SP_VISEME_8', 'DISPID_SGRSTransitions', 'SPAS_STOP',
    'SPBINARYGRAMMAR', 'DISPID_SGRsFindRule', 'SPAO_RETAIN_AUDIO',
    'ISpeechPhraseRule', 'DISPID_SVSpeak', 'DISPID_SVEWord',
    'DISPID_SAFType', 'SPSLMA', 'SPPS_Noncontent',
    'DISPID_SPELexicalForm', '_SPAUDIOSTATE',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRGetFormat',
    'SpeechRecognizerState', 'SpeechVoicePriority',
    ...
    'SREPropertyNumChange', 'SGRSTTWord', 'SPEI_REQUEST_UI', 'SVP_20',
    'SPVPRI_NORMAL', 'SVEWordBoundary', 'SASRun', 'SRERequestUI',
    'DISPID_SGRSTPropertyName', 'DISPID_SPEDisplayAttributes',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SMSAMMHandle',
    'DISPID_SVSLastBookmark', 'SPEVENTSOURCEINFO',
    'SDKLCurrentConfig', 'ISpeechGrammarRules',
    'DISPID_SPIReplacements', 'SPEI_PHRASE_START',
    'DISPID_SLRemovePronunciation', 'DISPID_SABIMinNotification',
    'SpSharedRecoContext', 'DISPID_SPISaveToMemory',
    'SpeechPropertyResponseSpeed', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPILanguageId', 'SP_VISEME_7', 'SGLexical',
    'ISpRecoGrammar2', 'DISPID_SRCEPropertyStringChange',
    'SPAUDIOBUFFERINFO', 'DISPID_SRCCreateGrammar',
    'DISPID_SPPConfidence', 'ISpRecognizer2',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpeechPhraseAlternate',
    'SPCS_DISABLED', 'Speech_Default_Weight', 'DISPID_SVVoice',
    'DISPID_SWFEFormatTag', 'SAFT22kHz8BitStereo',
    'DISPID_SOTDisplayUI', 'DISPID_SRRAudioFormat',
    'SPBOOKMARKOPTIONS', 'DISPID_SBSRead', 'SpInprocRecognizer',
    'DISPID_SLGenerationId', 'DISPID_SVEventInterests',
    'SPPS_RESERVED3', 'SITooLoud', 'SRERecoOtherContext',
    'DISPID_SpeechXMLRecoResult', 'SpeechTokenKeyAttributes',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFTCCITT_ALaw_22kHzMono', 'SPEVENTENUM', 'STCRemoteServer',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRGCmdSetRuleState',
    'SpeechRuleAttributes', 'SPDKL_DefaultLocation',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPXRO_SML', 'SITooQuiet', 'SDTDisplayText',
    'DISPID_SpeechObjectToken', 'SpResourceManager',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SOTCGetDataKey', 'SpeechRuleState', 'SPAO_NONE',
    'DISPID_SMSGetData', 'ISpRecognizer', 'SRAORetainAudio',
    'SVSFParseMask', 'SDKLLocalMachine',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPLO_STATIC',
    'DISPID_SPRuleFirstElement', 'ISpeechRecoResult',
    'SpeechTokenKeyFiles', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SPCIdToPhone', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPRNumberOfElements', 'DISPID_SLWsItem',
    'eLEXTYPE_PRIVATE11', 'DISPID_SVSLastStreamNumberQueued',
    'ISpSerializeState', 'SpeechRecoEvents', 'SPINTERFERENCE_TOOFAST',
    'SpeechDiscardType', 'SPSMF_SAPI_PROPERTIES', 'SAFT44kHz8BitMono',
    'DISPID_SRCEFalseRecognition', 'SVEBookmark',
    'DISPID_SGRSTPropertyValue', 'DISPID_SPERetainedSizeBytes',
    'SREHypothesis', 'DISPID_SGRAddResource',
    'DISPID_SRGDictationLoad', 'DISPID_SPIEngineId',
    'DISPID_SVAlertBoundary', 'DISPID_SPEPronunciation', 'SVP_18',
    'DISPID_SpeechLexiconWords', 'SAFT22kHz16BitMono',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPWT_LEXICAL',
    'SECFIgnoreKanaType', 'SSFMOpenForRead', 'SBONone',
    ...
    'SAFT48kHz8BitStereo', 'SRAExport', 'DISPID_SPIAudioSizeBytes',
    'Speech_Max_Word_Length', 'DISPID_SPIEnginePrivateData',
    'SPXRO_Alternates_SML', 'SpLexicon', 'ISpeechAudioBufferInfo',
    'SVP_8', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SAVolume', 'ISpNotifySink', 'DISPID_SRGReset',
    'DISPID_SRGIsPronounceable', 'SAFT11kHz16BitMono', 'SVPNormal',
    'DISPID_SRState', 'DISPID_SGRClear', 'SVSFParseSapi',
    'DISPID_SRGState', 'SECFIgnoreCase', 'DISPID_SRCRecognizer',
    'SPFILEMODE', 'STCLocalServer', 'DISPID_SVPause',
    'SPPS_SuppressWord', 'SAFTCCITT_ALaw_8kHzStereo',
    'eLEXTYPE_PRIVATE4', 'SASStop', 'eLEXTYPE_PRIVATE19',
    'DISPID_SOTSetId', 'DISPID_SpeechRecognizer', 'SPEI_TTS_BOOKMARK',
    'SpMMAudioEnum', 'DISPID_SPRulesCount', 'SREInterference',
    'DISPID_SBSWrite', 'ISpeechRecognizer',
    'SpeechVoiceSkipTypeSentence', 'SPPS_RESERVED1',
    'SPPHRASEREPLACEMENT', 'DISPID_SpeechCustomStream',
    'SPPHRASEPROPERTY', 'SpeechTokenShellFolder',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SRGCmdLoadFromObject', 'SGPronounciation',
    'eLEXTYPE_PRIVATE7', 'SAFT44kHz16BitMono', 'SGRSTTTextBuffer',
    'SPGS_ENABLED', 'SPAR_Low', 'SPEI_RECO_OTHER_CONTEXT',
    'SpMemoryStream', 'STCAll', 'DISPID_SRCCreateResultFromMemory',
    'SpeechVoiceEvents', 'DISPID_SMSSetData', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPCPhoneToId',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVGetProfiles', 'SAFT24kHz8BitMono', 'SREAdaptation',
    'SP_VISEME_10', 'SREFalseRecognition',
    'SpeechEmulationCompareFlags', 'SPEI_MIN_SR',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SWFEChannels', 'SAFT32kHz16BitStereo',
    'DISPID_SpeechGrammarRules', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPEI_FALSE_RECOGNITION', 'SPAS_RUN', 'SP_VISEME_21',
    'SpeechVoiceSpeakFlags', 'DISPID_SGRs_NewEnum',
    'SRSInactiveWithPurge', 'SPSNotOverriden', 'SAFT44kHz16BitStereo',
    'SDTAlternates', 'DISPID_SRCEHypothesis',
    'DISPID_SRRSetTextFeedback', 'DISPID_SPPsCount',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPRuleName', 'SPAR_High',
    'DISPID_SFSOpen', 'DISPID_SPRuleChildren', 'DISPID_SOTRemove',
    'SDA_No_Trailing_Space', 'ISpeechObjectToken', 'DISPID_SPPParent',
    'SRCS_Enabled', 'DISPID_SVSpeakCompleteEvent', 'DISPID_SOTsItem',
    'SVF_None', 'SpeechBookmarkOptions', 'DISPID_SpeechDataKey',
    'SGSEnabled', 'SGSExclusive', 'DISPID_SRGDictationUnload',
    'SpObjectTokenCategory', 'ISpRecoResult', 'eLEXTYPE_PRIVATE17',
    'DISPID_SVVolume', 'SPEI_HYPOTHESIS', 'SAFT12kHz8BitStereo',
    'SVP_5', 'SGSDisabled', 'eLEXTYPE_RESERVED4', 'SAFTDefault',
    'DISPID_SLPSymbolic', 'SPWORDLIST', 'SpeechAudioFormatGUIDText',
    'SP_VISEME_2', 'SPSHORTCUTPAIRLIST', 'SVSFIsNotXML',
    'SREPropertyStringChange', 'SAFT22kHz16BitStereo',
    'SAFTGSM610_11kHzMono', 'DISPID_SGRsAdd',
    'DISPID_SRCSetAdaptationData', 'SPSUnknown', 'DISPID_SRCState',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPEAudioSizeBytes',
    'SpMMAudioOut', 'ISpPhrase', 'SRTEmulated', 'SPPS_Verb',
    'DISPID_SpeechPhraseRule', 'SPINTERFERENCE', 'SSFMCreateForWrite',
    'DISPID_SpeechPhraseReplacements', 'SPPS_Modifier',
    'ISpEventSink', 'DISPID_SRRPhraseInfo', 'SPAR_Unknown',
    'DISPID_SRCEStartStream', 'ISpVoice', 'eLEXTYPE_PRIVATE9',
    'SpeechStreamSeekPositionType', 'SpeechMicTraining',
    'SDA_Two_Trailing_Spaces', 'DISPID_SPEsItem',
    'DISPID_SRGCmdLoadFromResource', 'SGDisplay',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRAudioInput', 'SSTTDictation',
    'DISPID_SLWPronunciations', 'DISPID_SGRId',
    'SPINTERFERENCE_TOOQUIET', 'SECLowConfidence',
    'DISPID_SABIEventBias', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SpeechObjectTokens', 'SAFT32kHz16BitMono', 'SSFMCreate',
    ...
    'IEnumString', 'DISPID_SRCERequestUI', 'SVSFPurgeBeforeSpeak',
    'SPSInterjection', 'SPEI_PROPERTY_NUM_CHANGE',
    'SAFT16kHz8BitMono', 'SpeechRunState', 'DISPID_SMSALineId',
    'SpeechVoiceCategoryTTSRate', 'SPRST_ACTIVE',
    'ISpeechLexiconPronunciation', 'SPPS_Unknown', 'SRSActiveAlways',
    'SpeechPropertyNormalConfidenceThreshold', 'eLEXTYPE_PRIVATE3',
    'SPRULESTATE', 'ISpeechPhraseInfoBuilder', 'SP_VISEME_17',
    'DISPID_SPRuleParent', 'SPINTERFERENCE_TOOSLOW',
    'SpeechTokenContext', 'SPINTERFERENCE_LATENCY_WARNING',
    'SITooFast', 'SPWF_INPUT', 'DISPID_SVSRunningState',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SPRFirstElement', 'SVP_15',
    'ISpeechRecoContext', 'DISPID_SGRSAddWordTransition',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SVP_9',
    'DISPIDSPTSI_SelectionLength', 'SVESentenceBoundary',
    'ISpObjectTokenCategory', 'SPRULE', 'SDTAudio', 'SRESoundStart',
    'SASClosed', 'DISPID_SPRuleConfidence', 'SPPS_Noun',
    'SpeechRecoContextState', 'DISPID_SMSADeviceId',
    'DISPIDSPTSI_ActiveLength', 'SVP_14', 'SPSHT_EMAIL',
    'SAFT32kHz8BitStereo', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SDKGetBinaryValue', 'SpeechTokenValueCLSID', 'SLTUser',
    'SPSSuppressWord', 'SpeechAddRemoveWord', 'DISPID_SVStatus',
    'DISPID_SVAudioOutputStream', 'DISPID_SRSClsidEngine',
    'DISPID_SBSFormat', 'DISPID_SVSLastBookmarkId',
    'DISPID_SDKDeleteKey', 'SSSPTRelativeToCurrentPosition',
    'SPCT_SLEEP', 'eLEXTYPE_RESERVED6', 'SAFTADPCM_22kHzStereo',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRRSaveToMemory', 'SPSFunction',
    'SPPROPERTYINFO', 'DISPID_SDKSetBinaryValue', 'SPCATEGORYTYPE',
    'eLEXTYPE_RESERVED10', 'SPWORDPRONUNCIATIONLIST',
    'ISpStreamFormat', 'DISPID_SGRsCommitAndSave',
    'SECNormalConfidence', 'SPCT_SUB_COMMAND', 'ISpRecognizer3',
    'DISPID_SpeechFileStream', 'DISPID_SAFGuid', 'DISPID_SPEsCount',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SVRate',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'eLEXTYPE_RESERVED8',
    'SPWF_SRENGINE', 'SVSFPersistXML', 'SPEI_RECO_STATE_CHANGE',
    'SSTTTextBuffer', 'SPEI_SR_BOOKMARK', 'DISPIDSPTSI_ActiveOffset',
    ...
    'ISpeechAudioStatus', 'DISPID_SDKGetStringValue', 'SP_VISEME_5',
    'SWTAdded', 'DISPID_SpeechPhoneConverter', 'DISPID_SRRSpeakAudio',
    'SpeechFormatType', 'ISpeechLexiconWord',
    'SWPUnknownWordPronounceable', 'SVSFIsXML', 'SDTAll',
    'DISPID_SCSBaseStream', 'SpeechSpecialTransitionType',
    'SPINTERFERENCE_NOSIGNAL', 'ISpeechRecognizerStatus',
    'SVSFParseSsml', 'SAFT8kHz8BitStereo', 'SPRST_NUM_STATES',
    'SPVPRI_OVER', 'SRADefaultToActive', 'SVP_6',
    'DISPID_SRCERecognition', 'eLEXTYPE_PRIVATE16',
    'DISPID_SOTs_NewEnum', 'DISPID_SGRSTs_NewEnum', 'SREPhraseStart',
    'SVP_10', 'SPRECORESULTTIMES', 'SPEI_START_INPUT_STREAM',
    'DISPID_SLWWord', 'DISPID_SPEAudioTimeOffset',
    'SPEI_VOICE_CHANGE', 'SPPARTOFSPEECH', 'DISPID_SRProfile',
    'SAFTExtendedAudioFormat', 'SAFT48kHz16BitStereo',
    'DISPID_SOTCreateInstance', 'SpeechRecognitionType', 'SVEViseme',
    'DISPID_SRGCommit', 'SPSMF_SRGS_SAPIPROPERTIES',
    '_ISpeechVoiceEvents', 'DISPID_SGRsCommit', 'ISpeechDataKey',
    'SPFM_OPEN_READWRITE', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SVESentenceBoundary', '__MIDL_IWinTypes_0009',
    '_RemotableHandle', 'SPWORDPRONUNCIATION', 'ISpLexicon',
    'ISpRecoGrammar', 'SPDKL_CurrentUser',
    'DISPID_SpeechRecoResultTimes', 'ISpeechVoiceStatus',
    'SpeechGrammarState', 'SPFM_OPEN_READONLY',
    'DISPID_SASFreeBufferSpace', 'SpWaveFormatEx', 'SWTDeleted',
    'SAFT44kHz8BitStereo', 'SPLO_DYNAMIC',
    'DISPID_SGRSAddRuleTransition', 'ISpProperties',
    'Speech_StreamPos_RealTime', 'DISPID_SLWs_NewEnum', 'SRAImport',
    'SPBO_NONE', 'DISPID_SRSSupportedLanguages',
    'ISpeechRecoResultDispatch', 'SVSFDefault', 'SAFT16kHz16BitMono',
    'DISPID_SOTId', 'SPPS_RESERVED2', 'SFTSREngine', 'SRTStandard',
    'SPPHRASERULE', 'ISequentialStream', 'SVP_1', 'SVP_7',
    'ISpDataKey', 'ISpeechLexiconWords', 'DISPID_SVGetVoices',
    'SDTRule', 'SREAudioLevel', 'DISPID_SRSNumberOfActiveRules',
    ...
    'DISPID_SRCESoundEnd', 'DISPID_SRRTStreamTime',
    'DISPID_SpeechRecoResult', 'SAFT16kHz8BitStereo',
    'SAFT8kHz16BitMono', 'SPSVerb', 'DISPID_SVPriority',
    'DISPID_SVEStreamStart', 'SREBookmark', 'ISpXMLRecoResult',
    'DISPID_SpeechPhraseInfo', 'SpPhraseInfoBuilder',
    'SAFT8kHz16BitStereo', 'SpNotifyTranslator',
    'DISPID_SAFGetWaveFormatEx', 'SRAONone', 'SAFT22kHz8BitMono',
    'DISPID_SPPFirstElement', 'DISPID_SPPsItem', 'SSTTWildcard',
    'eLEXTYPE_PRIVATE5', 'SVSFNLPMask', 'DISPID_SGRSTNextState',
    'SPWORDPRONOUNCEABLE', 'DISPID_SPPChildren',
    'SpeechRecoProfileProperties', 'SAFT11kHz8BitMono', 'SITooSlow',
    'SPEI_RECOGNITION', 'DISPID_SVResume', 'SAFTADPCM_11kHzMono',
    'SPGS_DISABLED', 'SRADynamic', 'DISPID_SVEStreamEnd',
    'SPEI_RESERVED2', 'SAFTText', 'SAFT11kHz8BitStereo',
    'SAFTNoAssignedFormat', 'SAFT24kHz16BitMono',
    'DISPID_SRRTTickCount', 'DISPID_SVDisplayUI',
    'DISPID_SRCEInterference', 'SLOStatic', 'eLEXTYPE_PRIVATE18',
    'DISPID_SABIBufferSize', 'SECFNoSpecialChars', 'SVEAllEvents',
    'DISPID_SOTsCount', 'DISPID_SRCERecognitionForOtherContext',
    'SVPOver', 'DISPID_SGRSTsCount', 'DISPID_SVEBookmark',
    'SPDATAKEYLOCATION', 'SAFT8kHz8BitMono', 'DISPID_SASetState',
    'DISPID_SpeechRecognizerStatus', 'SpeechVisemeFeature',
    'SpeechTokenKeyUI', 'SAFT16kHz16BitStereo', 'SRESoundEnd',
    'SPDKL_CurrentConfig', 'DISPID_SPAsItem', 'DISPID_SPPName',
    'DISPID_SDKSetStringValue', 'SpeechVisemeType',
    'ISpNotifyTranslator', 'SPCT_COMMAND',
    'ISpeechTextSelectionInformation', 'DISPID_SRRAlternates',
    'ISpPhoneticAlphabetConverter',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpeechCustomStream',
    'SVP_19', 'DISPID_SABufferInfo', 'SRAInterpreter', 'SP_VISEME_20',
    'SAFT24kHz8BitStereo', 'DISPID_SGRsCount', 'DISPID_SPACommit',
    'DISPID_SPIRetainedSizeBytes', 'IEnumSpObjectTokens',
    'ISpPhraseAlt', 'SBOPause', 'ISpeechResourceLoader',
    'SGDSInactive', 'SpeechAudioFormatGUIDWave',
    'ISpeechPhraseAlternates', 'DISPID_SGRSRule',
    'DISPID_SPRuleEngineConfidence',
    'SpeechGrammarTagUnlimitedDictation', 'SPCT_DICTATION',
    'SP_VISEME_9', 'DISPID_SpeechPhraseReplacement',
    'SpeechGrammarWordType', 'DISPID_SRCPause',
    'DISPID_SABufferNotifySize', 'SpObjectToken',
    'DISPID_SOTIsUISupported', 'SRERecognition', 'SPFM_NUM_MODES',
    'SPEI_WORD_BOUNDARY', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPCS_ENABLED', 'SGRSTTEpsilon', 'SPAUDIOSTATE',
    'DISPID_SGRAddState', 'ISpeechPhraseInfo', 'eLEXTYPE_MORPHOLOGY',
    'SRCS_Disabled', 'SpeechAudioFormatType',
    'DISPID_SWFESamplesPerSec', 'DISPID_SVGetAudioOutputs',
    'STSF_LocalAppData', 'DISPID_SVEEnginePrivate', 'ISpRecoCategory',
    'SPSEMANTICFORMAT', 'DISPID_SpeechLexiconProns', 'DISPID_SRGId',
    'DISPID_SRCRetainedAudioFormat',
    'SpeechPropertyHighConfidenceThreshold', 'SP_VISEME_14',
    'SRARoot', 'SVP_0', 'SpTextSelectionInformation',
    'ISpEventSource', 'ISpeechPhraseProperty',
    'DISPID_SPEActualConfidence', 'SASPause', 'STSF_AppData',
    'SGDSActiveWithAutoPause', 'SVEPhoneme', 'SP_VISEME_0',
    'ISpeechGrammarRule', 'SPEI_RESERVED1', 'SPRS_ACTIVE',
    'DISPID_SWFEBlockAlign', 'SVEVoiceChange', 'SPEI_PHONEME',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPCT_SUB_DICTATION',
    'SPEI_RESERVED5', 'SpeechUserTraining', 'DISPID_SOTCId',
    'SECFIgnoreWidth', 'SVSFIsFilename', 'DISPID_SRRTimes',
    'DISPID_SpeechPhraseRules', 'DISPID_SRCResume',
    'DISPID_SPEs_NewEnum', 'IStream', 'SpeechStreamFileMode',
    'SAFT12kHz16BitMono', 'DISPID_SRCESoundStart',
    'DISPID_SGRSTsItem', 'DISPID_SLPsItem', 'ISpeechAudioFormat',
    'SpeechAllElements', '_ISpeechRecoContextEvents', 'SRSActive',
    'DISPID_SpeechLexicon', 'ISpeechFileStream', 'SVSFlagsAsync',
    'ISpeechWaveFormatEx', 'DISPID_SOTGetStorageFileName',
    'SAFT48kHz8BitMono', 'DISPID_SWFEExtraData', 'SVP_17',
    'DISPID_SpeechPhraseAlternate', 'SPAUDIOOPTIONS',
    'SpeechGrammarTagWildcard', 'DISPID_SpeechObjectTokenCategory',
    'SP_VISEME_13', 'DISPID_SRCEventInterests', 'SRSEIsSpeaking',
    'SpeechGrammarTagDictation', 'SPAR_Medium', 'WAVEFORMATEX',
    'SGRSTTDictation', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SADefaultFormat', 'ISpeechPhoneConverter',
    'SAFTADPCM_22kHzMono', 'ISpeechObjectTokens',
    'SpeechDisplayAttributes', 'DISPID_SAFSetWaveFormatEx',
    'SPEI_VISEME', 'DISPID_SpeechPhraseProperty', 'DISPID_SPRsItem',
    'SpStreamFormatConverter', 'SVEAudioLevel', 'SpSharedRecognizer',
    'eLEXTYPE_USER_SHORTCUT', 'tagSPPROPERTYINFO', 'SP_VISEME_12',
    'SPWORD', 'SVF_Emphasis', 'SpeechRetainedAudioOptions',
    'SpAudioFormat', 'DISPID_SLAddPronunciation',
    'DISPID_SGRSTWeight', 'ISpRecoContext', 'SPRECOSTATE',
    'DISPID_SpeechAudioBufferInfo', 'SSSPTRelativeToEnd', 'SVPAlert',
    'DISPID_SpeechMemoryStream', 'ISpeechPhraseElement',
    'SAFTCCITT_uLaw_11kHzMono', 'SPAS_CLOSED', 'ISpeechBaseStream',
    'SAFT12kHz16BitStereo', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPCONTEXTSTATE', 'ISpeechLexicon', 'DISPID_SDKDeleteValue',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SVSInputSentenceLength',
    'SpeechCategoryVoices', 'SDTProperty', 'SPPS_Interjection',
    'eLEXTYPE_PRIVATE12', 'SINoSignal', 'SPVISEMES', 'SPEI_MAX_TTS',
    'SPSHT_NotOverriden', 'SPSERIALIZEDPHRASE', 'SDTPronunciation',
    'SGDSActive', 'SpeechTokenIdUserLexicon', 'SINone',
    'SVF_Stressed', 'ISpeechGrammarRuleState',
    'DISPID_SWFEBitsPerSample', 'DISPID_SOTCDefault', 'SPLOADOPTIONS',
    'SFTInput', 'SAFTNonStandardFormat', 'eLEXTYPE_PRIVATE8',
    'DISPID_SpeechAudioFormat', 'DISPID_SREmulateRecognition',
    'DISPID_SPANumberOfElementsInResult',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpObjectToken',
    'DISPID_SPRulesItem', 'SPSModifier', 'ISpeechRecoResult2',
    'ISpNotifySource', 'DISPID_SVSPhonemeId', 'SP_VISEME_15',
    ...
    'DISPID_SPRText', 'SPLEXICONTYPE', 'DISPID_SpeechLexiconWord',
    'SPRS_INACTIVE', 'SpVoice', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SPPId', 'SREStateChange', 'SRSEDone', 'SPBO_TIME_UNITS',
    'DISPID_SRCEAudioLevel', 'DISPID_SRCRequestedUIType',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SASState',
    'DISPID_SRStatus', 'DISPID_SRSCurrentStreamPosition',
    'STSF_FlagCreate', 'SPPS_RESERVED4', 'ISpRecoContext2',
    'SPEI_ADAPTATION', 'SPWAVEFORMATTYPE',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPSHORTCUTPAIR', 'SVP_13',
    'DISPID_SGRSTText', 'ISpeechPhraseElements',
    'SPINTERFERENCE_NOISE', 'DISPID_SRRGetXMLResult',
    'SpeechAudioVolume', 'DISPID_SDKCreateKey',
    'DISPID_SVEVoiceChange', 'DISPID_SPIRule',
    'ISpeechPhraseReplacements', 'SAFTGSM610_44kHzMono',
    'DISPID_SRSetPropertyString', 'DISPID_SRCVoicePurgeEvent',
    'SVP_3', 'DISPID_SPIProperties', 'SpShortcut',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPERequiredConfidence',
    'SPGS_EXCLUSIVE', 'SPRST_ACTIVE_ALWAYS', 'UINT_PTR',
    'SPEI_MAX_SR', 'DISPID_SOTGetDescription', 'DISPID_SVAudioOutput',
    'DISPID_SAEventHandle', 'SPEI_TTS_PRIVATE',
    'DISPID_SRCEEndStream', 'SSSPTRelativeToStart', 'SREPrivate',
    'SP_VISEME_16', 'ISpResourceManager', 'SPPS_NotOverriden',
    'DISPID_SVEViseme', 'DISPID_SPIElements', 'SECFEmulateResult',
    'SVSFParseAutodetect', 'ISpeechMMSysAudio', 'SAFTADPCM_8kHzMono',
    'SRTReSent', 'SGDSActiveUserDelimited', 'DISPID_SRCVoice',
    'SPEI_RESERVED3', 'SpStream', 'SPSTREAMFORMATTYPE',
    'SpeechWordType', 'SWPUnknownWordUnpronounceable',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SPAs_NewEnum',
    'ISpeechPhraseProperties', 'DISPID_SPCLangId',
    ...
    'SPPHRASEELEMENT', 'IInternetSecurityMgrSite', 'DISPID_SAStatus',
    'eWORDTYPE_DELETED', 'SPBO_PAUSE', 'DISPID_SRRRecoContext',
    'SpeechPropertyAdaptationOn', 'DISPIDSPTSI', 'DISPID_SGRsDynamic',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpeechEngineProperties',
    'STCInprocHandler', 'SPEI_TTS_AUDIO_LEVEL', 'SPWT_PRONUNCIATION',
    'DISPID_SDKEnumValues', 'DISPID_SRCRetainedAudio', 'SpFileStream',
    'SPSEMANTICERRORINFO', 'DISPID_SPRules_NewEnum',
    'ISpeechPhraseRules', 'SAFT12kHz8BitMono',
    'tagSPTEXTSELECTIONINFO', 'ISpeechAudio', 'SVP_11',
    'DISPID_SRRTLength', 'DISPID_SGRInitialState', 'SREAllEvents',
    'DISPID_SpeechAudio', 'SpeechCategoryPhoneConverters',
    'DISPID_SRSCurrentStreamNumber', 'SPSERIALIZEDRESULT',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SPAPhraseInfo',
    'ISpeechVoice', 'SRTSMLTimeout', 'DISPID_SGRSTRule',
    'SpMMAudioIn', 'DISPID_SGRsItem', 'DISPID_SLWsCount',
    'SPEI_INTERFERENCE', 'Speech_Max_Pron_Length',
    'SpeechLexiconType', 'ISpStream'
]

_check_version('1.2.0', 1683289277.714787)
